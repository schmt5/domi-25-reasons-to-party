    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-1hz66gu");
    			add_location(span, file, 58, 1, 920);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(58:0) {#each confetti as c}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Auses guete Domi";
    			attr_dev(h1, "class", "svelte-1hz66gu");
    			add_location(h1, file, 62, 0, 1039);
    			attr_dev(div, "class", "container svelte-1hz66gu");
    			add_location(div, file, 61, 0, 1015);
    		},
